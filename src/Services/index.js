...
<p class="service3">Scan diseases</p>
<br/>
...
<p class="service3">ICU facilities</p>
...
<p class="service3">Eye treatment</p>
<br/>
<br/>
...
<p class="service3">Nose treatment</p>
<br/>
...
<p class="service3">Heart treatment</p>
...
<p class="service3">Proper medication</p>
...
<p class="service3">Fist aid services</p>
...
<p class="service3">diagnostic services</p>
medical examinations, tests, and procedures performed by healthcare professionals to identify and determine the presence, nature, and extent of a disease, condition, or injury, aiding in accurate diagnosis and treatment planning.
<br/>
<p class="button2">
    <button class="btn3">Learn More</button>
    </p>
